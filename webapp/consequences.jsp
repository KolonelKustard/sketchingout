...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="640" height="480" id="consequences" align="middle">
  ...
  <embed src="consequences.swf?<jsp:getProperty name="consequencesBean" property="flashParams" />&make_flash_refresh=<%= new com.totalchange.consequences.RandomGUID().toString() %>" quality="high" bgcolor="#cccccc" width="640" height="480" name="consequences" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
</object>
</body>
</html>